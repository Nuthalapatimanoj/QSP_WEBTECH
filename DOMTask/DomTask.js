...
indianCricketTeam.map((ele)=>{
    ...
    let li = document.createElement("li")  //  Element creation using javascript

    li.innerText=ele.name                  //  Inserting the content html

    ol.append(li)                         // Used to display the content in webpage
})
